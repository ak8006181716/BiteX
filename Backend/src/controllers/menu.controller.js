...
const updateMenu = asyncHandler(async (req, res, next) => {
    const updatedMenu = await updateMenuService(req.params.id, req.body);
...
const addMenuItemToMenu = asyncHandler(async (req, res, next) => {
    const menuItem = await addMenuItemToMenuService(req.params.id, req.body);
...
const deleteMenuItemFromMenu = asyncHandler(async (req, res, next) => {
    await deleteMenuItemFromMenuService(req.params.id);
...
const updateMenuItem = asyncHandler(async (req, res, next) => {
    const updatedMenuItem = await updateMenuItemService(req.params.id, req.body);
